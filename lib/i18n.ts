...
const en = {
  ...
  footer: {
    ...
    groups: [
      ["Product", [["Tour", "#tour"], ["Client–server", "#core"], ["Remotes", "#remotes"], ["Plugins", "#plugins"], ["What's new", "#new"], ["Themes", "#themes"], ["Download", "#download"]]],
...
const es: Copy = {
  ...
  footer: {
    ...
    groups: [
      ["Producto", [["Recorrido", "#tour"], ["Cliente-servidor", "#core"], ["Remotos", "#remotes"], ["Plugins", "#plugins"], ["Novedades", "#new"], ["Temas", "#themes"], ["Descargar", "#download"]]],
