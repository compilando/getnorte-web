...
const en = {
  ...
  hero: {
    ...
    cta: {
      ...
      trust: ["Open source", "MCP", "No account", "No telemetry"],
    },
  ...
  tour: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Every copy, move, delete, sync and index runs in the background with progress and a clean cancel. Copies, moves and deletes pause and resume, and an optional serial queue spares spinning disks.",
      ...
      },
      {
        ...
        body: "Every mutation — yours, the window's, an agent's — lands in a journal. The timeline shows it and undoes back to any point: it never overwrites, and skips anything replaced since or that it cannot safely reverse.",
  ...
  agents: {
    ...
    body: "Claude, Codex or any MCP client reaches your files through the same core the human frontends use: scoped access you grant, expiring grants, changes held for your yes, attribution in the journal, and undo for an agent's session after it is gone.",
    flowLabel: "How an agent's change goes through norte",
    flow: [
      ["Agent", "asks for a scope: folders, operations, how long"],
      ["You", "grant it — and an ask rule holds each change for your y"],
...
const es: Copy = {
  ...
  hero: {
    ...
    lede: "Trabaja con ficheros locales, SFTP, S3 y comprimidos desde un único núcleo en Rust. Los agentes reciben acceso acotado, aprobación explícita, autoría y deshacer.",
    cta: {
      ...
      trust: ["Código abierto", "MCP", "Sin cuenta", "Sin telemetría"],
    },
  ...
  tour: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Cada copia, movimiento, borrado, sincronización e índice corre en segundo plano con progreso y cancelación limpia. Copias, movimientos y borrados se pausan y se reanudan, y una cola en serie opcional cuida los discos mecánicos.",
        keys: ["F5", "Ctrl+Alt+K", "Ctrl+Alt+Q"],
      },
      {
        scene: "timeline",
        ...
        body: "Cada cambio —tuyo, de la ventana, de un agente— queda en un diario. La línea de tiempo lo enseña y deshace hasta cualquier punto: nunca sobrescribe, y se salta lo que se ha sustituido después o lo que no puede revertir con seguridad.",
        keys: ["Ctrl+P timeline"],
      },
      {
        scene: "goto",
  ...
  agents: {
    ...
    body: "Claude, Codex o cualquier cliente MCP llegan a tus ficheros por el mismo núcleo que usan los frontends humanos: acceso acotado que tú concedes, permisos que caducan, cambios retenidos hasta tu sí, autoría en el diario y deshacer la sesión de un agente cuando ya se ha ido.",
    flowLabel: "Cómo pasa por norte el cambio de un agente",
    flow: [
      ["Agente", "pide un ámbito: carpetas, operaciones, cuánto tiempo"],
      ["Tú", "lo concedes, y una regla ask retiene cada cambio hasta tu y"],
